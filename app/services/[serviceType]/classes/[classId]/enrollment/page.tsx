...
const serviceTypeConfig = {
  angels: { name: "Angels", description: "Early childhood ministry" },
  primary: { name: "Primary", description: "Elementary age students" },
  secondary: { name: "Secondary", description: "Middle school students" },
  high: { name: "High", description: "High school students" },
  university: { name: "University", description: "College age ministry" },
  graduates: { name: "Graduates", description: "Post-graduate ministry" },
}

const mockAvailableStudents: Student[] = [
  { id: "1", name: "John Smith", age: 8, points: 850, status: "active" },
  { id: "2", name: "Sarah Johnson", age: 7, points: 920, status: "active" },
  { id: "3", name: "Michael Brown", age: 9, points: 780, status: "active" },
  { id: "4", name: "Emily Davis", age: 8, points: 1050, status: "active" },
  { id: "5", name: "David Wilson", age: 7, points: 690, status: "active" },
  { id: "6", name: "Lisa Anderson", age: 15, points: 1200, status: "active" },
  { id: "7", name: "James Taylor", age: 16, points: 980, status: "active" },
  { id: "8", name: "Anna Martinez", age: 14, points: 1150, status: "active" },
]

const mockCurrentEnrollments: Enrollment[] = [
  { id: "1", studentId: "9", studentName: "Robert Garcia", enrolledAt: "2024-01-15", status: "active" },
  { id: "2", studentId: "10", studentName: "Maria Rodriguez", enrolledAt: "2024-01-15", status: "active" },
  {
    id: "3",
    studentId: "11",
  ...
  { id: "4", studentId: "12", studentName: "Jennifer Brown", enrolledAt: "2024-01-20", status: "active" },
]

const mockAvailableClasses: Record<string, Array<{ id: string; name: string; teacher: string }>> = {
  angels: [
    { id: "class1", name: "Little Angels A", teacher: "Sister Mary" },
    { id: "class2", name: "Little Angels B", teacher: "Mrs. Johnson" },
  ],
  primary: [
    { id: "class3", name: "Primary Bible Stories", teacher: "Mr. Davis" },
    { id: "class4", name: "Primary Worship", teacher: "Ms. Wilson" },
  ],
  secondary: [
    { id: "class5", name: "Middle School Ministry", teacher: "Pastor Mike" },
    { id: "class6", name: "Teen Bible Study", teacher: "Mrs. Brown" },
  ],
  high: [
    { id: "class7", name: "High School Youth", teacher: "Pastor John" },
    { id: "class8", name: "Senior Prep Class", teacher: "Dr. Smith" },
  ],
  university: [
    { id: "class9", name: "College Fellowship", teacher: "Pastor Sarah" },
    { id: "class10", name: "Young Adults", teacher: "Mr. Thompson" },
  ],
  graduates: [
    { id: "class11", name: "Graduate Connect", teacher: "Dr. Williams" },
    { id: "class12", name: "Professional Ministry", teacher: "Mrs. Garcia" },
  ],
}
...
export default function ServiceEnrollmentPage({
  ...
  params: { serviceType: string; classId: string }
}) {
  ...
  const className = `${config?.name || "Service"} Class A`
  const availableClasses = mockAvailableClasses[serviceType] || []

  const filteredStudents = mockAvailableStudents.filter(
    (student) =>
      student.name.toLowerCase().includes(searchTerm.toLowerCase()) || student.age.toString().includes(searchTerm),
  )
    ...
    <div className="space-y-6">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink href={`/parishes/services/${serviceType}`}>{config.name}</BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
      ...
      <PageHeader
        ...
        description={`Manage student enrollment for ${config.description.toLowerCase()}`}
        action={
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <Input
                    placeholder="Search students by name or age..."
                    value={searchTerm}
