...
import { useServantManagement } from "@/hooks/useServantManagement";
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6">
            ...
            {/* Emergency Contact - Fields not in database schema */}
            <div className="bg-muted/50 border rounded-lg p-4">
              ...
              <p className="text-muted-foreground text-sm">
                Emergency contact fields are not included in the current
                database schema.
              </p>
            </div>

            {/* Additional Notes - Not in database schema */}
            <div className="bg-muted/50 border rounded-lg p-4">
              <h3 className="text-lg font-medium text-foreground mb-2">
                Additional Notes (Not Available)
              </h3>
              <p className="text-muted-foreground text-sm">
                Notes field is not included in the current database schema.
              </p>
            </div>
          </div>
