  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await createStoreItemAction({
        ...
        special_price_normal: formData.special_offer_enabled ? formData.special_price_normal : undefined,
        special_price_mastor: formData.special_offer_enabled ? formData.special_price_mastor : undefined,
        special_price_botl: formData.special_offer_enabled ? formData.special_price_botl : undefined,
