-- =====================================================
-- ANNOUNCEMENTS: VISIBILITY FALLBACK (derive church/diocese from class assignments)
-- =====================================================
-- Some student/teacher records may not have church_id set on public.users.
-- This updates can_read_announcement() to also match scope via the user's class assignments.
