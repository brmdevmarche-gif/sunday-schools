-- =====================================================
-- Store Items Table - Drop and Recreate
-- =====================================================
-- This migration drops the existing store_items table and recreates it
-- with the new schema for different pricing tiers

-- Drop existing policies if they exist
DROP POLICY IF EXISTS "Students can view store items" ON public.store_items;
DROP POLICY IF EXISTS "Admins can view all store items" ON public.store_items;
...
DROP FUNCTION IF EXISTS update_store_items_updated_at();
...
-- Create indexes
CREATE INDEX idx_store_items_church_id ON public.store_items(church_id);
CREATE INDEX idx_store_items_is_active ON public.store_items(is_active);
CREATE INDEX idx_store_items_created_at ON public.store_items(created_at DESC);
